    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('nilai_kinerja.update', $nilai_kinerja->id) }}">
                            @csrf
                            @method('PUT')
                            <section id="input-group-buttons">
                                                ...
                                                <div class="col-md-6 col-12 mb-1">
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-merge">
                                                                <input type="number" value="{{ old('nilai_1',$nilai_kinerja->nilai_1) }}" id="nilai_1"
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-merge">
                                                                <input type="number" value="{{ old('nilai_1',$nilai_kinerja->nilai_2) }}" id="nilai_2"
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-merge">
                                                                <input type="number" value="{{ old('nilai_1',$nilai_kinerja->nilai_3) }}" id="nilai_3"
                                ...
                                <div class="form-group" style="padding-top:20px">
                                    ...
                                    <a href="{{ url('nilai_kinerja') }}" class="btn bg-gradient-secondary">Kembali</a>
                                </div>
                            </section>
                        </form>
                    </div>

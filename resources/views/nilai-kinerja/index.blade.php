        ...
        <body>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('nilai_kinerja') }}">Nilai kinerja</a></li>
                        ...
                        <div class="card">
                            ...
                            <ul class="list-group list-group-flush" style="padding-top:30px; padding-left:30px">
                                <li class="list-group-item">
                                    <H6>Indikator kinerja 1</H6>
                                    <p class="card-text">{{ $item->indikator_kinerja_1 }}</p>
                                </li>
                                <li class="list-group-item">
                                    <H6>Indikator kinerja 2</H6>
                                    <p class="card-text">{{ $item->indikator_kinerja_2 }}</p>
                                </li>
                                <li class="list-group-item">
                                    <H6>Indikator kinerja 3</H6>
                                    <p class="card-text">{{ $item->indikator_kinerja_3 }}</p>
                                </li>
                            </ul>
                            <div class="card-footer text-left">
                                @if (Request::is('indikator_kinerja'))
                                    <a href="{{ route('indikator_kinerja.edit', $item->id) }}"
            ...
            <div class="container" style="padding-top: 20px">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Daftar Nilai kinerja</h5>
                                @if (Auth::user()->role === 'Admin Hrd')
                                    <div>
                                        <a href="{{ url('nilai_kinerja/create') }}" class="btn btn-gradient-primary"
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($nilai_kinerja  as $item)
                                                    <tr data-id="{{ $item->id }}">
                                                        ...
                                                        <td>{{ $item->nilai_2 }}</td>
                                                        <td>{{ $item->nilai_3 }}</td>
                                                        <td>{{ $item->total_nilai_kinerja }}</td>
                                                        <td>
                                                            <span class="badge badge-light-warning me-1">
                                                                {{ $item->status_data_kinerja }}
                                                            </span>
                                                        </td>
                                                        @if ($item->status_data_kinerja == 'Revisi')
                                                            <td>
                                                                <button type="button"
                                                        ...
                                                        @elseif ($item->status_data_kinerja == 'approved')
                                                            <td>  <button type="button"
                                                                class="btn btn-warning waves-effect waves-float waves-light">
                                                                Sesuai
                                                            </button></td>
                                                        @elseif (
                                                            ($item->status_data_kinerja != 'approved' && Auth::user()->role == 'Admin Hrd') ||
                                                        ...
                                                        @endif
                                                        <td>
                                                            @if ($item->status_data_kinerja === 'pending' && in_array(Auth::user()->role, [
                                                                'Kepala Dep.Hrd',
                                                                'Kepala Dep.Environment',
                                                                'Kepala Dep.Engineering',
                                                                'Kepala Dep.Accounting',
                                                                ...
                                                                <form method="POST" action="{{ route('nilai_kinerja.approve', ['id' => $item->id]) }}">
                                                                    @csrf
                                                            ...
                                                            @if ($item->status_data_kinerja === 'Revisi' && Auth::user()->role === 'Admin Hrd')
                                                                <a href="{{ route('nilai_kinerja.edit', $item->id) }}" class="btn btn-warning">Edit</a>
                                                            @endif
                                                            ...
                                                            <a href="{{ route('nilai_kinerja.show', $item->id) }}"
                                                                ...
                                                                {{--  <a href="{{ route('nilai_kinerja.show', $item->id) }}" class="btn btn-info">Show</a>  --}}
                                                            @endif
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form method="POST"
                                                                        action="{{ route('nilai_kinerja.destroy', $item->id) }}">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="button"
                                                    ...
                                                    <div class="modal fade"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form method="POST"
                                                                    action="{{ route('nilai_kinerja.revisi', ['id' => $item->id]) }}">
                                                                    @csrf
                                                                    <div class="modal-body">

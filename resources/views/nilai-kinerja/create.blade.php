    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('nilai_kinerja.store') }}">
                            @csrf
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-merge">
                                                                <input type="text" value="{{ old('nik_karyawan', session('nik_karyawan')) }}"
                                                                    ...
                                                                    name="nik_karyawan" required  readonly>
                                                                @error('nik_karyawan')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data) {
                            ...
                            $('#namaDepartemen').val(data.departments_id ? data.departments_id : 'Data tidak tersedia');
                        } else {

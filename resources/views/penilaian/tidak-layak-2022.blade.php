        ...
        <body>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('thn_2022') }}">Penilaian 2022</a></li>
            ...
            <div class="container" style="padding-top: 20px">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Daftar Data Tidak Layak</h5>
                                <div>
                                    <a href="{{ url('/tidak-layak-pdf-2022') }}" class="btn btn-gradient-danger" target="_blank"

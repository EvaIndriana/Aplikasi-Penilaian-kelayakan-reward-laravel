                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div
                                    ...
                                    <div class="position-relative h-100 m-1 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                        style="background-image: url('{{ asset('argon-template/assets/img/login2.jpg') }}'); background-size: 1020px;background-position: center;">
                                        <span class="mask bg-gradient-primary opacity-6"></span>
                                        <h4 class="mt-5 text-white font-weight-bolder position-relative">"Aplikasi Reward
                                            Karyawan"</h4>
                                        <p class="text-white position-relative">Ketika kita berusaha untuk menjadi lebih
                                            baik, segala sesuatu di sekitar kita menjadi lebih baik juga</p>
                                    </div>
                                </div>

    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('nilai_loyalitas.store') }}">
                            @csrf
                            <section id="input-group-buttons">
                                                    ...
                                                    <div class="col-6" style="padding-top:10px">
                                                        ...
                                                        <div class="col-9">
                                                            <div class="mb-2">
                                                                ...
                                                                <textarea class="form-control"  id="note" disabled> Tetap bertahan dalam organisasi.</textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-9">
                                                            <div class="mb-2">
                                                                ...
                                                                <textarea class="form-control"  id="note" disabled>Mau mengorbankan kepentingan pribadi demi kepentingan organisasi/perusahaan.
                                                                </textarea>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-9">
                                                            <div class="mb-2">
                                                                ...
                                                                <textarea class="form-control"  id="note" disabled>Menawarkan saran-saran untuk perbaikan
                                                                </textarea>
                                                            </div>
                                                        </div>
                                ...
                                <div class="form-group" style="padding-top:20px">
                                    ...
                                    <a href="{{ url('nilai_loyalitas') }}" class="btn bg-gradient-secondary">Kembali</a>
                                </div>
                            </section>
                        </form>
                    </div>

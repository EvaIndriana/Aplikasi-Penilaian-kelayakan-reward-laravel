    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('nilai_loyalitas.update', $nilai_loyalitas->id) }}">
                            @csrf
                            @method('PUT')
                                                ...
                                                <div class="col-md-6 col-12 mb-1">
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-merge">
                                                                <input type="number" value="{{ old('nilai_1',$nilai_loyalitas->nilai_1) }}" id="nilai_1"
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-merge">
                                                                <input type="number" value="{{ old('nilai_1',$nilai_loyalitas->nilai_2) }}" id="nilai_2"
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-merge">
                                                                <input type="number" value="{{ old('nilai_1',$nilai_loyalitas->nilai_3) }}" id="nilai_3"

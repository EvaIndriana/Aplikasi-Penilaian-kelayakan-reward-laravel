        ...
        <body>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('nilai_loyalitas') }}">Nilai Loyaliats</a></li>
                        ...
                        <div class="card">
                            ...
                            <ul class="list-group list-group-flush" style="padding-top:30px; padding-left:30px">
                                <li class="list-group-item">
                                    <H6>Indikator loyalitas 1</H6>
                                    <p class="card-text">{{ $item->indikator_loyalitas_1 }}</p>
                                </li>
                                <li class="list-group-item">
                                    <H6>Indikator loyalitas 2</H6>
                                    <p class="card-text">{{ $item->indikator_loyalitas_2 }}</p>
                                </li>
                                <li class="list-group-item">
                                    <H6>Indikator loyalitas 3</H6>
                                    <p class="card-text">{{ $item->indikator_loyalitas_3 }}</p>
                                </li>
                            </ul>
                            <div class="card-footer text-left">
                                @if (Request::is('indikator_loyalitas'))
                                    <a href="{{ route('indikator_loyalitas.edit', $item->id) }}"
            ...
            <div class="container" style="padding-top: 20px">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Daftar Nilai loyalitas</h5>
                                @if (Auth::user()->role === 'Admin Hrd')
                                    <div>
                                        <a href="{{ url('nilai_loyalitas/create') }}" class="btn btn-gradient-primary"
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped" id="datatables">
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($nilai_loyalitas as $item)
                                                    <tr data-id="{{ $item->id }}">
                                                        ...
                                                        <td>{{ $item->nilai_2 }}</td>
                                                        <td>{{ $item->nilai_3 }}</td>
                                                        <td>{{ $item->total_nilai_loyalitas }}</td>
                                                        <td>
                                                            <span class="badge badge-light-warning me-1">
                                                                {{ $item->status_data_loyalitas }}
                                                            </span>
                                                        </td>
                                                        @if ($item->status_data_loyalitas == 'Revisi')
                                                            <td>
                                                                <button type="button"
                                                        ...
                                                        @elseif ($item->status_data_loyalitas == 'approved')
                                                            <td>  <button type="button"
                                                                class="btn btn-warning waves-effect waves-float waves-light">
                                                                Sesuai
                                                            </button></td>
                                                        @elseif (
                                                            ($item->status_data_loyalitas != 'approved' && Auth::user()->role == 'Admin Hrd') ||
                                                        ...
                                                        @endif
                                                        <td>
                                                            @if ($item->status_data_loyalitas === 'pending' && in_array(Auth::user()->role, [
                                                                'Kepala Dep.Hrd',
                                                                'Kepala Dep.Environment',
                                                                'Kepala Dep.Engineering',
                                                                'Kepala Dep.Accounting',
                                                                ...
                                                                <form method="POST" action="{{ route('nilai_loyalitas.approve', ['id' => $item->id]) }}">
                                                                    @csrf
                                                                    <button type="submit" name="approval" value="sesuai" class="btn btn-success" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top" title=""
                                                                    data-bs-original-title="Kerangan akhir">Sesuai</button>
                                                                </form>
                                                            ...
                                                            @if ($item->status_data_loyalitas === 'Revisi' && Auth::user()->role === 'Admin Hrd')
                                                                <a href="{{ route('nilai_loyalitas.edit', $item->id) }}" class="btn btn-warning">Edit</a>
                                                            @endif
                                                            ...
                                                            <a href="{{ route('nilai_loyalitas.show', $item->id) }}"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form method="POST"
                                                                        action="{{ route('nilai_loyalitas.destroy', $item->id) }}">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="button"
                                                    ...
                                                    <div class="modal fade"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form method="POST"
                                                                    action="{{ route('nilai_loyalitas.revisi', ['id' => $item->id]) }}">
                                                                    @csrf
                                                                    <div class="modal-body">

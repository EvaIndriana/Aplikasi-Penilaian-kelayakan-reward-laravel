            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                        <div class="card">
                            <div class="card-body">
                                <a href="{{ url('nilai_komunikasi') }}" class="btn btn-primary w-100 mb-75 waves-effect waves-float waves-light">Kembali</a>
                                <a href="{{ url('/nilai_komunikasi/' . $karyawan->id . '/download-pdf') }}"
